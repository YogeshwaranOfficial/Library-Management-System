                ...
                <table className="w-full text-left border-collapse table-fixed min-w-200">
                  <thead>
                    <tr className="border-b border-gray-200 text-[11px] font-bold text-[#718096] uppercase tracking-widest bg-transparent select-none">
                      <th className="pb-3 pr-4 font-bold tracking-widest w-[18%] pl-3">
                        System ID
                      </th>
                      <th className="pb-3 px-4 font-bold tracking-widest w-[25%]">
                        User Name
                      </th>
                      <th className="pb-3 px-4 font-bold tracking-widest w-[27%]">
                        Email Address
                      </th>
                      <th className="pb-3 px-4 font-bold tracking-widest w-[18%]">
                        Phone Number
                      </th>
                      <th className="pb-3 px-4 font-bold tracking-widest w-[12%]">
                        Entry Date
                      </th>
                    </tr>
                  </thead>
                    ...
                    {usersList.length === 0 ? (
                      ...
                      usersList.map((user: UserRecord) => {
                        ...
                        return (
                          ...
                          >
                            <td className="py-3.5 pr-4 pl-3  text-[11px] font-bold text-[#718096] uppercase truncate">
