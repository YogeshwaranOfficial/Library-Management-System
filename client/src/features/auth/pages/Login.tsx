  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 px-4 font-sans selection:bg-amber-100">
      <motion.div
        ...
        className="w-full max-w-100 bg-card-bg rounded-2xl shadow-xl border border-border-main/60 overflow-hidden"
      >
        {/* Branding Header */}
        <div className="bg-slate-900 p-8 text-center text-white border-b border-slate-800">
          ...
          <p className="text-[11px] uppercase tracking-widest text-slate-400 font-bold mt-1">
        ...
        <form onSubmit={handleFormSubmission} className="p-8 space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1 rounded-xl">
              <button
                ...
                className={`py-2 text-[11px] font-bold rounded-lg transition-all ${selectedRole === "LIBRARIAN" ? "bg-card-bg text-text-main shadow-xs" : "text-slate-500 hover:text-text-main"}`}
              >
                Librarian
              </button>
              <button
                ...
                className={`py-2 text-[11px] font-bold rounded-lg transition-all ${selectedRole === "ADMIN" ? "bg-card-bg text-text-main shadow-xs" : "text-slate-500 hover:text-text-main"}`}
              >
                Admin
              </button>
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <Mail
                className="absolute left-3 top-3 text-slate-400 group-focus-within:text-text-main transition-colors"
                size={16}
              />
              <input
                type="email"
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-border-main rounded-xl text-sm font-semibold text-text-main outline-none focus:border-slate-900 focus:ring-4 focus:ring-slate-900/5 transition-all"
              />
            </div>
            {fieldErrors.email && (
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <button
                type="button"
                onClick={() => toast.info("Contact Systems Admin.")}
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-border-main rounded-xl text-sm font-semibold text-text-main outline-none focus:border-slate-900 focus:ring-4 focus:ring-slate-900/5 transition-all"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-3 text-slate-400 hover:text-text-main"
              >
