      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 border border-gray-100 animate-zoom-in">
        <div className="text-center">
          ...
          <p className="text-[11px] text-red-600 font-semibold mt-2 bg-red-50 p-2 rounded-lg">
            Warning: This action cannot be undone and will permanently remove all copy records.
          </p>
        </div>
        <div className="mt-5 flex justify-end gap-3 pt-4 border-t border-gray-100">
          ...
          <button type="button" onClick={onConfirm} className="px-3.5 py-1.5 text-xs font-bold text-white bg-rose-600 hover:bg-rose-700 rounded-lg shadow-xs transition-all cursor-pointer">Confirm Delete</button>
        </div>
      </div>
    </div>
  );
