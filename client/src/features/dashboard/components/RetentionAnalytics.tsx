    ...
    <div className="bg-white p-6 rounded-2xl border border-slate-200/60 shadow-xs flex flex-col justify-between min-h-65 text-left font-sans">
      <div>
        <h3 className="text-[11px] font-bold text-slate-400 uppercase tracking-wider flex items-center gap-1.5">
          <Clock size={14} className="text-slate-500" /> Retention Lifetime Policy
        </h3>
      ...
      <div className="text-center py-5 space-y-1">
        <div className="text-4xl font-bold text-slate-900 tracking-tight font-sans">
          {avg} <span className="text-xl font-semibold tracking-normal text-slate-400">Days</span>
        </div>
      ...
      <div className="bg-slate-50/50 border border-slate-200/60 p-3.5 rounded-xl text-center space-y-1">
