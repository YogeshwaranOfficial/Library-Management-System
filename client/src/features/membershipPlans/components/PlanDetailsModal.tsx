  ...
  return (
    <>
      <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-fade-in text-left">
        <div className="bg-card-bg rounded-2xl shadow-xl w-full max-w-md overflow-hidden border border-amber-100/80 animate-zoom-in text-text-main">
          {/* Header Strip Layer */}
          <div className="text-white border-b border-slate-100 px-6 py-5 bg-slate-900 flex justify-between items-center">
            <div>
              ...
              <p className="font-mono text-xs text-slate-400 tracking-wider mt-0.5">
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 hover:bg-slate-100 rounded-lg text-slate-400 hover:text-text-main transition-colors cursor-pointer"
            >
              <X size={16} />
            </button>
          </div>
          ...
          <div className="p-6 space-y-4">
            <div className="space-y-1">
              <span className="text-slate-400 block text-xs uppercase font-bold tracking-wide">
                Plan Name
              </span>
              <div className="text-base font-bold text-text-main bg-slate-50 p-3.5 rounded-xl border border-border-main/60 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-slate-50 p-4 rounded-xl border border-border-main/60 space-y-1">
                ...
                <span className="font-mono font-bold text-text-main text-base block">
          ...
          <div className="p-4 bg-slate-50/50 border-t border-slate-100 grid grid-cols-2 gap-3 text-xs font-bold tracking-wide">
            <button
              ...
              className="flex items-center justify-center gap-1.5 py-3 px-4 bg-card-bg border border-rose-200 text-rose-600 uppercase rounded-xl hover:bg-rose-50 transition-all cursor-pointer shadow-sm"
            >
